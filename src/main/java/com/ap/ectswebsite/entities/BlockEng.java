...
@Entity
public class BlockEng implements Serializable {
    @Id
    ...
    public BlockEng(Set<BlockEng> blocks, String naam, Set<CourseEng> courses, int orde, int type, String description, String descriptionOption, int choiceOption, int choicePackage, String schoolYear) {
        this.blocks = blocks;
        this.naam = naam;

...
@Entity
public class CourseEng implements Serializable, Comparable<CourseEng> {
    @Id
    ...
    public CourseEng(String ects, String name, int orde, int studypoints, String schoolYear) {
        this.ects = ects;
        this.name = name;
        this.orde = orde;
    ...
    @Override
    public int compareTo(CourseEng course) {
